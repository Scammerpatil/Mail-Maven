          ...
          <div className="w-full px-4">
            ...
            >
              ...
              <p className="mb-12 text-base !leading-relaxed font-extralight text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                Mail Maven is designed to revolutionize email communication with
                powerful, user-friendly features. Whether you're sending
                personalized messages or bulk emails, our system streamlines the
                process with HTML and plain-text support, dynamic attachments,
                and Excel-based customization. With Mail Maven, you can
                effortlessly generate custom certificates and send them out with
                just a few clicks. Say goodbye to manual email tasks and hello
                to a smarter, more efficient way to manage your communication.
                Experience the future of automated email marketing and
                communication with Mail Maven.
              </p>
              <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                ...
                <Link
                  href="https://github.com/Scammerpatil/Mail-Maven"
